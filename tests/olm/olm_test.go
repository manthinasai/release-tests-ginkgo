...
var _ = Describe("OLM Operator Lifecycle: PIPELINES-09", Serial, Label("olm", "admin"), func() {
	...
	Describe("Install openshift-pipelines operator: PIPELINES-09-TC01", Label("install", "sanity"), Ordered, func() {
	...
	Describe("Upgrade openshift-pipelines operator: PIPELINES-09-TC02", Label("upgrade"), Ordered, func() {
	...
	Describe("Uninstall openshift-pipelines operator: PIPELINES-09-TC03", Label("uninstall"), Ordered, func() {
